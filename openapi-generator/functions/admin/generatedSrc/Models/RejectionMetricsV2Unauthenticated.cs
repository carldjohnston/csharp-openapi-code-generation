...
namespace Agl.Cdr.Admin.Models
{
    ...
    /// </summary>
    [DataContract(Name = "RejectionMetricsV2_unauthenticated")]
    public partial class RejectionMetricsV2Unauthenticated : IEquatable<RejectionMetricsV2Unauthenticated>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RejectionMetricsV2Unauthenticated" /> class.
        /// </summary>
        ...
        public RejectionMetricsV2Unauthenticated(decimal currentDay = default(decimal), List<decimal> previousDays = default(List<decimal>))
        {
        ...
        /// </summary>
        /// <value>Number of calls rejected for current day</value>
        ...
        /// </summary>
        /// <value>Number of calls rejected for previous days. The first element indicates yesterday and so on. A maximum of seven entries is required if available.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RejectionMetricsV2Unauthenticated {\n");
        ...
        {
            return this.Equals(input as RejectionMetricsV2Unauthenticated);
        }

        /// <summary>
        /// Returns true if RejectionMetricsV2Unauthenticated instances are equal
        /// </summary>
        /// <param name="input">Instance of RejectionMetricsV2Unauthenticated to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RejectionMetricsV2Unauthenticated input)
        {
            if (input == null)
                return false;
