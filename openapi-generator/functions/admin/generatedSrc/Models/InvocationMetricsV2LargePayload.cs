...
namespace Agl.Cdr.Admin.Models
{
    ...
    /// </summary>
    [DataContract(Name = "InvocationMetricsV2_largePayload")]
    public partial class InvocationMetricsV2LargePayload : IEquatable<InvocationMetricsV2LargePayload>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InvocationMetricsV2LargePayload" /> class.
        /// </summary>
        ...
        public InvocationMetricsV2LargePayload(decimal currentDay = default(decimal), List<decimal> previousDays = default(List<decimal>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InvocationMetricsV2LargePayload {\n");
        ...
        {
            return this.Equals(input as InvocationMetricsV2LargePayload);
        }

        /// <summary>
        /// Returns true if InvocationMetricsV2LargePayload instances are equal
        /// </summary>
        /// <param name="input">Instance of InvocationMetricsV2LargePayload to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InvocationMetricsV2LargePayload input)
        {
            if (input == null)
                return false;
