...
namespace Agl.Cdr.Admin.Models
{
    ...
    /// </summary>
    [DataContract(Name = "ResponseErrorListV2_errors")]
    public partial class ResponseErrorListV2Errors : IEquatable<ResponseErrorListV2Errors>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResponseErrorListV2Errors" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ResponseErrorListV2Errors() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ResponseErrorListV2Errors" /> class.
        /// </summary>
        ...
        public ResponseErrorListV2Errors(string code = default(string), string title = default(string), string detail = default(string), MetaError meta = default(MetaError))
        {
            // to ensure "code" is required (not null)
            this.Code = code ?? throw new ArgumentNullException("code is a required property for ResponseErrorListV2Errors and cannot be null");
            // to ensure "title" is required (not null)
            this.Title = title ?? throw new ArgumentNullException("title is a required property for ResponseErrorListV2Errors and cannot be null");
            // to ensure "detail" is required (not null)
            this.Detail = detail ?? throw new ArgumentNullException("detail is a required property for ResponseErrorListV2Errors and cannot be null");
            this.Meta = meta;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ResponseErrorListV2Errors {\n");
        ...
        {
            return this.Equals(input as ResponseErrorListV2Errors);
        }

        /// <summary>
        /// Returns true if ResponseErrorListV2Errors instances are equal
        /// </summary>
        /// <param name="input">Instance of ResponseErrorListV2Errors to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResponseErrorListV2Errors input)
        {
            if (input == null)
                return false;
