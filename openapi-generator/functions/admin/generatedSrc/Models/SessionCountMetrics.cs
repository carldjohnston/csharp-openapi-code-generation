...
namespace Agl.Cdr.Admin.Models
{
    ...
    /// </summary>
    [DataContract(Name = "SessionCountMetrics")]
    public partial class SessionCountMetrics : IEquatable<SessionCountMetrics>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SessionCountMetrics" /> class.
        /// </summary>
        ...
        public SessionCountMetrics(decimal currentDay = default(decimal), List<decimal> previousDays = default(List<decimal>))
        {
        ...
        /// </summary>
        /// <value>Session count for current day</value>
        ...
        /// </summary>
        /// <value>Session count for previous days. The first element indicates yesterday and so on. A maximum of seven entries is required if available</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SessionCountMetrics {\n");
        ...
        {
            return this.Equals(input as SessionCountMetrics);
        }

        /// <summary>
        /// Returns true if SessionCountMetrics instances are equal
        /// </summary>
        /// <param name="input">Instance of SessionCountMetrics to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SessionCountMetrics input)
        {
            if (input == null)
                return false;
