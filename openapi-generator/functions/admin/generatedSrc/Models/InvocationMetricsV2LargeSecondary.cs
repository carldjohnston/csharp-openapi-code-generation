...
namespace Agl.Cdr.Admin.Models
{
    ...
    /// </summary>
    [DataContract(Name = "InvocationMetricsV2_largeSecondary")]
    public partial class InvocationMetricsV2LargeSecondary : IEquatable<InvocationMetricsV2LargeSecondary>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InvocationMetricsV2LargeSecondary" /> class.
        /// </summary>
        ...
        public InvocationMetricsV2LargeSecondary(decimal currentDay = default(decimal), List<decimal> previousDays = default(List<decimal>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InvocationMetricsV2LargeSecondary {\n");
        ...
        {
            return this.Equals(input as InvocationMetricsV2LargeSecondary);
        }

        /// <summary>
        /// Returns true if InvocationMetricsV2LargeSecondary instances are equal
        /// </summary>
        /// <param name="input">Instance of InvocationMetricsV2LargeSecondary to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InvocationMetricsV2LargeSecondary input)
        {
            if (input == null)
                return false;
