...
namespace Agl.Cdr.Admin.Models
{
    ...
    /// </summary>
    [DataContract(Name = "AverageResponseMetricsV2_lowPriority")]
    public partial class AverageResponseMetricsV2LowPriority : IEquatable<AverageResponseMetricsV2LowPriority>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AverageResponseMetricsV2LowPriority" /> class.
        /// </summary>
        ...
        public AverageResponseMetricsV2LowPriority(decimal currentDay = default(decimal), List<decimal> previousDays = default(List<decimal>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AverageResponseMetricsV2LowPriority {\n");
        ...
        {
            return this.Equals(input as AverageResponseMetricsV2LowPriority);
        }

        /// <summary>
        /// Returns true if AverageResponseMetricsV2LowPriority instances are equal
        /// </summary>
        /// <param name="input">Instance of AverageResponseMetricsV2LowPriority to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AverageResponseMetricsV2LowPriority input)
        {
            if (input == null)
                return false;
