...
namespace Agl.Cdr.Admin.Models
{
    ...
    /// </summary>
    [DataContract(Name = "RejectionMetricsV2_authenticated")]
    public partial class RejectionMetricsV2Authenticated : IEquatable<RejectionMetricsV2Authenticated>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RejectionMetricsV2Authenticated" /> class.
        /// </summary>
        ...
        public RejectionMetricsV2Authenticated(decimal currentDay = default(decimal), List<decimal> previousDays = default(List<decimal>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RejectionMetricsV2Authenticated {\n");
        ...
        {
            return this.Equals(input as RejectionMetricsV2Authenticated);
        }

        /// <summary>
        /// Returns true if RejectionMetricsV2Authenticated instances are equal
        /// </summary>
        /// <param name="input">Instance of RejectionMetricsV2Authenticated to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RejectionMetricsV2Authenticated input)
        {
            if (input == null)
                return false;
