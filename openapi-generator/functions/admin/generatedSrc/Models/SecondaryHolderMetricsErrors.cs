...
namespace Agl.Cdr.Admin.Models
{
    ...
    /// </summary>
    [DataContract(Name = "SecondaryHolderMetrics_errors")]
    public partial class SecondaryHolderMetricsErrors : IEquatable<SecondaryHolderMetricsErrors>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SecondaryHolderMetricsErrors" /> class.
        /// </summary>
        ...
        public SecondaryHolderMetricsErrors(decimal currentDay = default(decimal), List<decimal> previousDays = default(List<decimal>))
        {
        ...
        /// </summary>
        /// <value>Number of errors for current day</value>
        ...
        /// </summary>
        /// <value>Number of errors for previous days. The first element indicates yesterday and so on. A maximum of seven entries is required if available</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SecondaryHolderMetricsErrors {\n");
        ...
        {
            return this.Equals(input as SecondaryHolderMetricsErrors);
        }

        /// <summary>
        /// Returns true if SecondaryHolderMetricsErrors instances are equal
        /// </summary>
        /// <param name="input">Instance of SecondaryHolderMetricsErrors to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SecondaryHolderMetricsErrors input)
        {
            if (input == null)
                return false;
