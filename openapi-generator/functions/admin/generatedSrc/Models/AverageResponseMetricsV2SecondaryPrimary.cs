...
namespace Agl.Cdr.Admin.Models
{
    ...
    /// </summary>
    [DataContract(Name = "AverageResponseMetricsV2_secondary_primary")]
    public partial class AverageResponseMetricsV2SecondaryPrimary : IEquatable<AverageResponseMetricsV2SecondaryPrimary>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AverageResponseMetricsV2SecondaryPrimary" /> class.
        /// </summary>
        ...
        public AverageResponseMetricsV2SecondaryPrimary(decimal currentDay = default(decimal), List<decimal> previousDays = default(List<decimal>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AverageResponseMetricsV2SecondaryPrimary {\n");
        ...
        {
            return this.Equals(input as AverageResponseMetricsV2SecondaryPrimary);
        }

        /// <summary>
        /// Returns true if AverageResponseMetricsV2SecondaryPrimary instances are equal
        /// </summary>
        /// <param name="input">Instance of AverageResponseMetricsV2SecondaryPrimary to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AverageResponseMetricsV2SecondaryPrimary input)
        {
            if (input == null)
                return false;
