...
namespace Agl.Cdr.Admin.Models
{
    ...
    /// </summary>
    [DataContract(Name = "AverageResponseMetricsV2_highPriority")]
    public partial class AverageResponseMetricsV2HighPriority : IEquatable<AverageResponseMetricsV2HighPriority>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AverageResponseMetricsV2HighPriority" /> class.
        /// </summary>
        ...
        public AverageResponseMetricsV2HighPriority(decimal currentDay = default(decimal), List<decimal> previousDays = default(List<decimal>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AverageResponseMetricsV2HighPriority {\n");
        ...
        {
            return this.Equals(input as AverageResponseMetricsV2HighPriority);
        }

        /// <summary>
        /// Returns true if AverageResponseMetricsV2HighPriority instances are equal
        /// </summary>
        /// <param name="input">Instance of AverageResponseMetricsV2HighPriority to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AverageResponseMetricsV2HighPriority input)
        {
            if (input == null)
                return false;
