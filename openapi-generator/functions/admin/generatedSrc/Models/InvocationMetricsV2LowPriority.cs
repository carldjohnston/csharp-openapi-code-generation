...
namespace Agl.Cdr.Admin.Models
{
    ...
    /// </summary>
    [DataContract(Name = "InvocationMetricsV2_lowPriority")]
    public partial class InvocationMetricsV2LowPriority : IEquatable<InvocationMetricsV2LowPriority>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InvocationMetricsV2LowPriority" /> class.
        /// </summary>
        ...
        public InvocationMetricsV2LowPriority(decimal currentDay = default(decimal), List<decimal> previousDays = default(List<decimal>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InvocationMetricsV2LowPriority {\n");
        ...
        {
            return this.Equals(input as InvocationMetricsV2LowPriority);
        }

        /// <summary>
        /// Returns true if InvocationMetricsV2LowPriority instances are equal
        /// </summary>
        /// <param name="input">Instance of InvocationMetricsV2LowPriority to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InvocationMetricsV2LowPriority input)
        {
            if (input == null)
                return false;
