...
namespace Agl.Cdr.Energy.Models
{
    ...
    /// EnergyAccount
    /// </summary>
    [DataContract(Name = "EnergyAccount")]
    public partial class EnergyAccount : IEquatable<EnergyAccount>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EnergyAccount" /> class.
        /// </summary>
        ...
        public EnergyAccount(string accountId = default(string), string accountNumber = default(string), string displayName = default(string), string creationDate = default(string), List<EnergyAccountAllOfPlans> plans = default(List<EnergyAccountAllOfPlans>))
        {
            // to ensure "accountId" is required (not null)
            this.AccountId = accountId ?? throw new ArgumentNullException("accountId is a required property for EnergyAccount and cannot be null");
            // to ensure "creationDate" is required (not null)
            this.CreationDate = creationDate ?? throw new ArgumentNullException("creationDate is a required property for EnergyAccount and cannot be null");
            // to ensure "plans" is required (not null)
            this.Plans = plans ?? throw new ArgumentNullException("plans is a required property for EnergyAccount and cannot be null");
        ...
        public List<EnergyAccountAllOfPlans> Plans { get; set; }
        ...
        {
            return this.Equals(input as EnergyAccount);
        }

        /// <summary>
        /// Returns true if EnergyAccount instances are equal
        /// </summary>
        /// <param name="input">Instance of EnergyAccount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EnergyAccount input)
        {
            if (input == null)
                return false;
