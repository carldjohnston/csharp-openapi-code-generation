...
namespace Agl.Cdr.Energy.Models
{
    ...
    /// EnergyAccountBase
    /// </summary>
    [DataContract(Name = "EnergyAccountBase")]
    public partial class EnergyAccountBase : IEquatable<EnergyAccountBase>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EnergyAccountBase" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EnergyAccountBase() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EnergyAccountBase" /> class.
        /// </summary>
        ...
        public EnergyAccountBase(string accountId = default(string), string accountNumber = default(string), string displayName = default(string), string creationDate = default(string))
        {
            // to ensure "accountId" is required (not null)
            this.AccountId = accountId ?? throw new ArgumentNullException("accountId is a required property for EnergyAccountBase and cannot be null");
            // to ensure "creationDate" is required (not null)
            this.CreationDate = creationDate ?? throw new ArgumentNullException("creationDate is a required property for EnergyAccountBase and cannot be null");
        ...
        {
            return this.Equals(input as EnergyAccountBase);
        }

        /// <summary>
        /// Returns true if EnergyAccountBase instances are equal
        /// </summary>
        /// <param name="input">Instance of EnergyAccountBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EnergyAccountBase input)
        {
            if (input == null)
                return false;
