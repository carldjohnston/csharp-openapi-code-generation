...
namespace Agl.Cdr.Energy.Models
{
    ...
    /// </summary>
    [DataContract(Name = "EnergyBillingDemandTransaction")]
    public partial class EnergyBillingDemandTransaction : IEquatable<EnergyBillingDemandTransaction>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EnergyBillingDemandTransaction" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EnergyBillingDemandTransaction() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EnergyBillingDemandTransaction" /> class.
        /// </summary>
        ...
        /// <param name="startDate">Date and time when the demand period starts (required).</param>
        /// <param name="endDate">Date and time when the demand period ends (required).</param>
        /// <param name="rate">The rate for the demand charge in kVA.  A negative value indicates power generated (required).</param>
        ...
        public EnergyBillingDemandTransaction(string servicePointId = default(string), string invoiceNumber = default(string), TimeOfUseTypeEnum timeOfUseType = default(TimeOfUseTypeEnum), string description = default(string), bool isEstimate = default(bool), string startDate = default(string), string endDate = default(string), decimal rate = default(decimal), string amount = default(string), List<EnergyBillingUsageTransactionCalculationFactors> calculationFactors = default(List<EnergyBillingUsageTransactionCalculationFactors>), List<EnergyBillingUsageTransactionAdjustments> adjustments = default(List<EnergyBillingUsageTransactionAdjustments>))
        {
            this.TimeOfUseType = timeOfUseType;
            // to ensure "startDate" is required (not null)
            this.StartDate = startDate ?? throw new ArgumentNullException("startDate is a required property for EnergyBillingDemandTransaction and cannot be null");
            // to ensure "endDate" is required (not null)
            this.EndDate = endDate ?? throw new ArgumentNullException("endDate is a required property for EnergyBillingDemandTransaction and cannot be null");
            this.Rate = rate;
            // to ensure "amount" is required (not null)
            this.Amount = amount ?? throw new ArgumentNullException("amount is a required property for EnergyBillingDemandTransaction and cannot be null");
        ...
        /// </summary>
        /// <value>Date and time when the demand period starts</value>
        ...
        /// </summary>
        /// <value>Date and time when the demand period ends</value>
        ...
        /// </summary>
        /// <value>The rate for the demand charge in kVA.  A negative value indicates power generated</value>
        ...
        {
            return this.Equals(input as EnergyBillingDemandTransaction);
        }

        /// <summary>
        /// Returns true if EnergyBillingDemandTransaction instances are equal
        /// </summary>
        /// <param name="input">Instance of EnergyBillingDemandTransaction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EnergyBillingDemandTransaction input)
        {
            if (input == null)
                return false;
