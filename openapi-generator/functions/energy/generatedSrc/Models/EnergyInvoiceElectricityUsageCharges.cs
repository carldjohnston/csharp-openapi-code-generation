...
namespace Agl.Cdr.Energy.Models
{
    ...
    /// </summary>
    [DataContract(Name = "EnergyInvoiceElectricityUsageCharges")]
    public partial class EnergyInvoiceElectricityUsageCharges : IEquatable<EnergyInvoiceElectricityUsageCharges>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EnergyInvoiceElectricityUsageCharges" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EnergyInvoiceElectricityUsageCharges() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EnergyInvoiceElectricityUsageCharges" /> class.
        /// </summary>
        ...
        public EnergyInvoiceElectricityUsageCharges(string totalUsageCharges = default(string), string totalGenerationCredits = default(string), string totalOnceOffCharges = default(string), string totalOnceOffDiscounts = default(string), List<EnergyInvoiceGasUsageChargesOtherCharges> otherCharges = default(List<EnergyInvoiceGasUsageChargesOtherCharges>), string totalGst = default(string))
        {
            // to ensure "totalUsageCharges" is required (not null)
            this.TotalUsageCharges = totalUsageCharges ?? throw new ArgumentNullException("totalUsageCharges is a required property for EnergyInvoiceElectricityUsageCharges and cannot be null");
            // to ensure "totalGenerationCredits" is required (not null)
            this.TotalGenerationCredits = totalGenerationCredits ?? throw new ArgumentNullException("totalGenerationCredits is a required property for EnergyInvoiceElectricityUsageCharges and cannot be null");
            // to ensure "totalOnceOffCharges" is required (not null)
            this.TotalOnceOffCharges = totalOnceOffCharges ?? throw new ArgumentNullException("totalOnceOffCharges is a required property for EnergyInvoiceElectricityUsageCharges and cannot be null");
            // to ensure "totalOnceOffDiscounts" is required (not null)
            this.TotalOnceOffDiscounts = totalOnceOffDiscounts ?? throw new ArgumentNullException("totalOnceOffDiscounts is a required property for EnergyInvoiceElectricityUsageCharges and cannot be null");
        ...
        {
            return this.Equals(input as EnergyInvoiceElectricityUsageCharges);
        }

        /// <summary>
        /// Returns true if EnergyInvoiceElectricityUsageCharges instances are equal
        /// </summary>
        /// <param name="input">Instance of EnergyInvoiceElectricityUsageCharges to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EnergyInvoiceElectricityUsageCharges input)
        {
            if (input == null)
                return false;
