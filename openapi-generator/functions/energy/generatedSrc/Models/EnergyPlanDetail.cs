...
namespace Agl.Cdr.Energy.Models
{
    ...
    /// EnergyPlanDetail
    /// </summary>
    [DataContract(Name = "EnergyPlanDetail")]
    public partial class EnergyPlanDetail : IEquatable<EnergyPlanDetail>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EnergyPlanDetail" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EnergyPlanDetail() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EnergyPlanDetail" /> class.
        /// </summary>
        ...
        public EnergyPlanDetail(string planId = default(string), string effectiveFrom = default(string), string effectiveTo = default(string), string lastUpdated = default(string), string displayName = default(string), string description = default(string), TypeEnum type = default(TypeEnum), FuelTypeEnum fuelType = default(FuelTypeEnum), string brand = default(string), string brandName = default(string), string applicationUri = default(string), EnergyPlanAdditionalInformation additionalInformation = default(EnergyPlanAdditionalInformation), CustomerTypeEnum? customerType = default(CustomerTypeEnum?), EnergyPlanGeography geography = default(EnergyPlanGeography), List<EnergyPlanDetailAllOfMeteringCharges> meteringCharges = default(List<EnergyPlanDetailAllOfMeteringCharges>), EnergyPlanContractFull gasContract = default(EnergyPlanContractFull), EnergyPlanContractFull electricityContract = default(EnergyPlanContractFull))
        {
            // to ensure "planId" is required (not null)
            this.PlanId = planId ?? throw new ArgumentNullException("planId is a required property for EnergyPlanDetail and cannot be null");
            // to ensure "lastUpdated" is required (not null)
            this.LastUpdated = lastUpdated ?? throw new ArgumentNullException("lastUpdated is a required property for EnergyPlanDetail and cannot be null");
            this.Type = type;
            this.FuelType = fuelType;
            // to ensure "brand" is required (not null)
            this.Brand = brand ?? throw new ArgumentNullException("brand is a required property for EnergyPlanDetail and cannot be null");
            // to ensure "brandName" is required (not null)
            this.BrandName = brandName ?? throw new ArgumentNullException("brandName is a required property for EnergyPlanDetail and cannot be null");
        ...
        {
            return this.Equals(input as EnergyPlanDetail);
        }

        /// <summary>
        /// Returns true if EnergyPlanDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of EnergyPlanDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EnergyPlanDetail input)
        {
            if (input == null)
                return false;
