# Agl.Cdr.Common.Apis.CommonApi

All URIs are relative to *https://data.holder.com.au/cds-au/v1*

Method | HTTP request | Description
------------- | ------------- | -------------
[**GetCustomer**](CommonApi.md#getcustomer) | **GET** /common/customer | Get Customer
[**GetCustomerDetail**](CommonApi.md#getcustomerdetail) | **GET** /common/customer/detail | Get Customer Detail
[**GetOutages**](CommonApi.md#getoutages) | **GET** /discovery/outages | Get Outages
[**GetStatus**](CommonApi.md#getstatus) | **GET** /discovery/status | Get Status
...
namespace Example
{
    public class GetCustomerDetailExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling CommonApi.GetCustomerDetail: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class GetOutagesExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling CommonApi.GetOutages: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class GetStatusExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling CommonApi.GetStatus: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
