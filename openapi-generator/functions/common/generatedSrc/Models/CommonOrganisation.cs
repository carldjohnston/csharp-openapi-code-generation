...
namespace Agl.Cdr.Common.Models
{
    ...
    /// CommonOrganisation
    /// </summary>
    [DataContract(Name = "CommonOrganisation")]
    public partial class CommonOrganisation : IEquatable<CommonOrganisation>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CommonOrganisation" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CommonOrganisation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CommonOrganisation" /> class.
        /// </summary>
        ...
        public CommonOrganisation(string lastUpdateTime = default(string), string agentFirstName = default(string), string agentLastName = default(string), string agentRole = default(string), string businessName = default(string), string legalName = default(string), string shortName = default(string), string abn = default(string), string acn = default(string), bool isACNCRegistered = default(bool), string industryCode = default(string), IndustryCodeVersionEnum? industryCodeVersion = IndustryCodeVersionEnum.V20, OrganisationTypeEnum organisationType = default(OrganisationTypeEnum), string registeredCountry = default(string), string establishmentDate = default(string))
        {
            // to ensure "agentLastName" is required (not null)
            this.AgentLastName = agentLastName ?? throw new ArgumentNullException("agentLastName is a required property for CommonOrganisation and cannot be null");
            // to ensure "agentRole" is required (not null)
            this.AgentRole = agentRole ?? throw new ArgumentNullException("agentRole is a required property for CommonOrganisation and cannot be null");
            // to ensure "businessName" is required (not null)
            this.BusinessName = businessName ?? throw new ArgumentNullException("businessName is a required property for CommonOrganisation and cannot be null");
        ...
        {
            return this.Equals(input as CommonOrganisation);
        }

        /// <summary>
        /// Returns true if CommonOrganisation instances are equal
        /// </summary>
        /// <param name="input">Instance of CommonOrganisation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CommonOrganisation input)
        {
            if (input == null)
                return false;
