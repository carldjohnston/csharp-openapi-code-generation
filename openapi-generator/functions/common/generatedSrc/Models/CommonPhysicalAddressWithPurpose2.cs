...
{
    /// <summary>
    /// CommonPhysicalAddressWithPurpose2
    /// </summary>
    [DataContract(Name = "CommonPhysicalAddressWithPurpose2")]
    public partial class CommonPhysicalAddressWithPurpose2 : IEquatable<CommonPhysicalAddressWithPurpose2>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CommonPhysicalAddressWithPurpose2" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CommonPhysicalAddressWithPurpose2() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CommonPhysicalAddressWithPurpose2" /> class.
        /// </summary>
        ...
        public CommonPhysicalAddressWithPurpose2(AddressUTypeEnum addressUType = default(AddressUTypeEnum), CommonSimpleAddress simple = default(CommonSimpleAddress), CommonPAFAddress paf = default(CommonPAFAddress), PurposeEnum purpose = default(PurposeEnum))
        {
        ...
        {
            return this.Equals(input as CommonPhysicalAddressWithPurpose2);
        }

        /// <summary>
        /// Returns true if CommonPhysicalAddressWithPurpose2 instances are equal
        /// </summary>
        /// <param name="input">Instance of CommonPhysicalAddressWithPurpose2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CommonPhysicalAddressWithPurpose2 input)
        {
            if (input == null)
                return false;
