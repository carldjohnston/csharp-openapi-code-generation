...
namespace Org.OpenAPITools.Agl.Cdr.Admin
{
    ...
    /// </summary>
    [DataContract(Name = "ErrorMetrics")]
    public partial class ErrorMetrics : IEquatable<ErrorMetrics>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ErrorMetrics" /> class.
        /// </summary>
        ...
        public ErrorMetrics(decimal currentDay = default(decimal), List<decimal> previousDays = default(List<decimal>))
        {
        ...
        {
            return this.Equals(input as ErrorMetrics);
        }

        /// <summary>
        /// Returns true if ErrorMetrics instances are equal
        /// </summary>
        /// <param name="input">Instance of ErrorMetrics to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ErrorMetrics input)
        {
            if (input == null)
                return false;
