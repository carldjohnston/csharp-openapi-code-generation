...
namespace Org.OpenAPITools.Agl.Cdr.Admin
{
    ...
    /// </summary>
    [DataContract(Name = "InvocationMetricsV2")]
    public partial class InvocationMetricsV2 : IEquatable<InvocationMetricsV2>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InvocationMetricsV2" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InvocationMetricsV2() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InvocationMetricsV2" /> class.
        /// </summary>
        ...
        public InvocationMetricsV2(InvocationMetricsV2Unauthenticated unauthenticated = default(InvocationMetricsV2Unauthenticated), InvocationMetricsV2HighPriority highPriority = default(InvocationMetricsV2HighPriority), InvocationMetricsV2LowPriority lowPriority = default(InvocationMetricsV2LowPriority), InvocationMetricsV2Unattended unattended = default(InvocationMetricsV2Unattended), InvocationMetricsV2LargePayload largePayload = default(InvocationMetricsV2LargePayload), InvocationMetricsV2Secondary secondary = default(InvocationMetricsV2Secondary), InvocationMetricsV2LargeSecondary largeSecondary = default(InvocationMetricsV2LargeSecondary))
        {
            // to ensure "unauthenticated" is required (not null)
            this.Unauthenticated = unauthenticated ?? throw new ArgumentNullException("unauthenticated is a required property for InvocationMetricsV2 and cannot be null");
            // to ensure "highPriority" is required (not null)
            this.HighPriority = highPriority ?? throw new ArgumentNullException("highPriority is a required property for InvocationMetricsV2 and cannot be null");
            // to ensure "lowPriority" is required (not null)
            this.LowPriority = lowPriority ?? throw new ArgumentNullException("lowPriority is a required property for InvocationMetricsV2 and cannot be null");
            // to ensure "unattended" is required (not null)
            this.Unattended = unattended ?? throw new ArgumentNullException("unattended is a required property for InvocationMetricsV2 and cannot be null");
            // to ensure "largePayload" is required (not null)
            this.LargePayload = largePayload ?? throw new ArgumentNullException("largePayload is a required property for InvocationMetricsV2 and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InvocationMetricsV2 {\n");
        ...
        {
            return this.Equals(input as InvocationMetricsV2);
        }

        /// <summary>
        /// Returns true if InvocationMetricsV2 instances are equal
        /// </summary>
        /// <param name="input">Instance of InvocationMetricsV2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InvocationMetricsV2 input)
        {
            if (input == null)
                return false;
