...
namespace Org.OpenAPITools.Agl.Cdr.Admin
{
    ...
    /// </summary>
    [DataContract(Name = "AverageResponseMetricsV2_largePayload")]
    public partial class AverageResponseMetricsV2LargePayload : IEquatable<AverageResponseMetricsV2LargePayload>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AverageResponseMetricsV2LargePayload" /> class.
        /// </summary>
        ...
        public AverageResponseMetricsV2LargePayload(decimal currentDay = default(decimal), List<decimal> previousDays = default(List<decimal>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AverageResponseMetricsV2LargePayload {\n");
        ...
        {
            return this.Equals(input as AverageResponseMetricsV2LargePayload);
        }

        /// <summary>
        /// Returns true if AverageResponseMetricsV2LargePayload instances are equal
        /// </summary>
        /// <param name="input">Instance of AverageResponseMetricsV2LargePayload to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AverageResponseMetricsV2LargePayload input)
        {
            if (input == null)
                return false;
