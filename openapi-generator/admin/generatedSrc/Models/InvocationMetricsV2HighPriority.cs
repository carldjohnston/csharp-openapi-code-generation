...
namespace Org.OpenAPITools.Agl.Cdr.Admin
{
    ...
    /// </summary>
    [DataContract(Name = "InvocationMetricsV2_highPriority")]
    public partial class InvocationMetricsV2HighPriority : IEquatable<InvocationMetricsV2HighPriority>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InvocationMetricsV2HighPriority" /> class.
        /// </summary>
        ...
        public InvocationMetricsV2HighPriority(decimal currentDay = default(decimal), List<decimal> previousDays = default(List<decimal>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InvocationMetricsV2HighPriority {\n");
        ...
        {
            return this.Equals(input as InvocationMetricsV2HighPriority);
        }

        /// <summary>
        /// Returns true if InvocationMetricsV2HighPriority instances are equal
        /// </summary>
        /// <param name="input">Instance of InvocationMetricsV2HighPriority to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InvocationMetricsV2HighPriority input)
        {
            if (input == null)
                return false;
