...
namespace Org.OpenAPITools.Agl.Cdr.Admin
{
    ...
    /// </summary>
    [DataContract(Name = "InvocationMetricsV2_unauthenticated")]
    public partial class InvocationMetricsV2Unauthenticated : IEquatable<InvocationMetricsV2Unauthenticated>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InvocationMetricsV2Unauthenticated" /> class.
        /// </summary>
        ...
        public InvocationMetricsV2Unauthenticated(decimal currentDay = default(decimal), List<decimal> previousDays = default(List<decimal>))
        {
        ...
        {
            return this.Equals(input as InvocationMetricsV2Unauthenticated);
        }

        /// <summary>
        /// Returns true if InvocationMetricsV2Unauthenticated instances are equal
        /// </summary>
        /// <param name="input">Instance of InvocationMetricsV2Unauthenticated to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InvocationMetricsV2Unauthenticated input)
        {
            if (input == null)
                return false;
