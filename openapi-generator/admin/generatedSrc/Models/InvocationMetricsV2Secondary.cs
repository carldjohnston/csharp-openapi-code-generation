...
namespace Org.OpenAPITools.Agl.Cdr.Admin
{
    ...
    /// </summary>
    [DataContract(Name = "InvocationMetricsV2_secondary")]
    public partial class InvocationMetricsV2Secondary : IEquatable<InvocationMetricsV2Secondary>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InvocationMetricsV2Secondary" /> class.
        /// </summary>
        ...
        public InvocationMetricsV2Secondary(decimal currentDay = default(decimal), List<decimal> previousDays = default(List<decimal>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InvocationMetricsV2Secondary {\n");
        ...
        {
            return this.Equals(input as InvocationMetricsV2Secondary);
        }

        /// <summary>
        /// Returns true if InvocationMetricsV2Secondary instances are equal
        /// </summary>
        /// <param name="input">Instance of InvocationMetricsV2Secondary to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InvocationMetricsV2Secondary input)
        {
            if (input == null)
                return false;
