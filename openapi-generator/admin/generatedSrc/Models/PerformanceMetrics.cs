...
namespace Org.OpenAPITools.Agl.Cdr.Admin
{
    ...
    public partial class PerformanceMetrics : IEquatable<PerformanceMetrics>, IValidatableObject
    {
        /// <summary>
        ...
        public PerformanceMetrics(decimal currentDay = default(decimal), List<decimal> previousDays = default(List<decimal>))
        {
        ...
        {
            return this.Equals(input as PerformanceMetrics);
        }

        /// <summary>
        /// Returns true if PerformanceMetrics instances are equal
        /// </summary>
        /// <param name="input">Instance of PerformanceMetrics to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PerformanceMetrics input)
        {
            if (input == null)
                return false;
