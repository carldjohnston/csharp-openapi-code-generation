...
using Agl.Cdr.Admin.Authentication;
using Agl.Cdr.Admin.Filters;
using Agl.Cdr.Admin.OpenApi;
using Agl.Cdr.Admin.Formatters;
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services
                .AddSwaggerGen(c =>
                {
                    ...
                    {
                        Title = "CDR Admin API",
                        Description = "CDR Admin API (ASP.NET Core 3.1)",
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwagger(c =>
                ...
                .UseSwaggerUI(c =>
                {
                    ...
                    c.SwaggerEndpoint("/openapi/1.15.0/openapi.json", "CDR Admin API");

                    //TODO: Or alternatively use the original OpenAPI contract that's included in the static files
                    // c.SwaggerEndpoint("/openapi-original.json", "CDR Admin API Original");
                });
            app.UseRouting();
