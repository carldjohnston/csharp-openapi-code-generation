...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class AverageResponseMetricsV2LargePayload : IEquatable<AverageResponseMetricsV2LargePayload>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((AverageResponseMetricsV2LargePayload)obj);
        }

        /// <summary>
        /// Returns true if AverageResponseMetricsV2LargePayload instances are equal
        /// </summary>
        /// <param name="other">Instance of AverageResponseMetricsV2LargePayload to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AverageResponseMetricsV2LargePayload other)
        {
        ...
        public static bool operator ==(AverageResponseMetricsV2LargePayload left, AverageResponseMetricsV2LargePayload right)
        {
