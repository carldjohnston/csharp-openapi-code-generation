...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class AverageResponseMetricsV2LowPriority : IEquatable<AverageResponseMetricsV2LowPriority>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((AverageResponseMetricsV2LowPriority)obj);
        }

        /// <summary>
        /// Returns true if AverageResponseMetricsV2LowPriority instances are equal
        /// </summary>
        /// <param name="other">Instance of AverageResponseMetricsV2LowPriority to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AverageResponseMetricsV2LowPriority other)
        {
        ...
        public static bool operator ==(AverageResponseMetricsV2LowPriority left, AverageResponseMetricsV2LowPriority right)
        {
