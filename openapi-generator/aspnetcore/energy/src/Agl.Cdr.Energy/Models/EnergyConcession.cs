...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class EnergyConcession : IEquatable<EnergyConcession>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((EnergyConcession)obj);
        }

        /// <summary>
        /// Returns true if EnergyConcession instances are equal
        /// </summary>
        /// <param name="other">Instance of EnergyConcession to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EnergyConcession other)
        {
            ...
            return 
                ...
                (
                    DailyDiscount == other.DailyDiscount ||
                    DailyDiscount != null &&
                ...
                (
                    ...
                    MonthlyDiscount.Equals(other.MonthlyDiscount)
                ) && 
                (
                    YearlyDiscount == other.YearlyDiscount ||
                    YearlyDiscount != null &&
                    YearlyDiscount.Equals(other.YearlyDiscount)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + DailyDiscount.GetHashCode();
                    if (MonthlyDiscount != null)
                    hashCode = hashCode * 59 + MonthlyDiscount.GetHashCode();
                    if (YearlyDiscount != null)
                    hashCode = hashCode * 59 + YearlyDiscount.GetHashCode();
        ...
        public static bool operator ==(EnergyConcession left, EnergyConcession right)
        {
