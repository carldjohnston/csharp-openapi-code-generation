...
{
    /// <summary> The EnergyInvoiceElectricityUsageCharges. </summary>
    public partial class EnergyInvoiceElectricityUsageCharges
    {
        /// <summary> Initializes a new instance of EnergyInvoiceElectricityUsageCharges. </summary>
        ...
        internal EnergyInvoiceElectricityUsageCharges(string totalUsageCharges, string totalGenerationCredits, string totalOnceOffCharges, string totalOnceOffDiscounts)
        {
        ...
        internal EnergyInvoiceElectricityUsageCharges(string totalUsageCharges, string totalGenerationCredits, string totalOnceOffCharges, string totalOnceOffDiscounts, IReadOnlyList<EnergyInvoiceGasUsageChargesOtherCharges> otherCharges, string totalGst)
        {
            TotalUsageCharges = totalUsageCharges;
            TotalGenerationCredits = totalGenerationCredits;
            TotalOnceOffCharges = totalOnceOffCharges;
