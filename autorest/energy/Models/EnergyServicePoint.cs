...
{
    /// <summary> The EnergyServicePoint. </summary>
    public partial class EnergyServicePoint
    {
        /// <summary> Initializes a new instance of EnergyServicePoint. </summary>
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="servicePointId"/>, <paramref name="nationalMeteringId"/>, <paramref name="validFromDate"/>, or <paramref name="lastUpdateDateTime"/> is null. </exception>
        internal EnergyServicePoint(string servicePointId, string nationalMeteringId, EnergyServicePointClassification servicePointClassification, EnergyServicePointStatus servicePointStatus, EnergyServicePointJurisdictionCode jurisdictionCode, string validFromDate, string lastUpdateDateTime)
        {
        ...
        internal EnergyServicePoint(string servicePointId, string nationalMeteringId, EnergyServicePointClassification servicePointClassification, EnergyServicePointStatus servicePointStatus, EnergyServicePointJurisdictionCode jurisdictionCode, bool? isGenerator, string validFromDate, string lastUpdateDateTime, EnergyServicePointConsumerProfile consumerProfile)
        {
            ServicePointId = servicePointId;
            NationalMeteringId = nationalMeteringId;
            ServicePointClassification = servicePointClassification;
        ...
        public EnergyServicePointClassification ServicePointClassification { get; }
        ...
        public EnergyServicePointStatus ServicePointStatus { get; }
        /// <summary> Jurisdiction code to which the service point belongs.This code defines the jurisdictional rules which apply to the service point. Note the details of enumeration values below:&lt;ul&gt;&lt;li&gt;**ALL** - All Jurisdictions&lt;/li&gt;&lt;li&gt;**ACT** - Australian Capital Territory&lt;/li&gt;&lt;li&gt;**NEM** - National Electricity Market&lt;/li&gt;&lt;li&gt;**NSW** - New South Wales&lt;/li&gt;&lt;li&gt;**QLD** - Queensland&lt;/li&gt;&lt;li&gt;**SA** - South Australia&lt;/li&gt;&lt;li&gt;**TAS** - Tasmania&lt;/li&gt;&lt;li&gt;**VIC** - Victoria&lt;/li&gt;&lt;/ul&gt;. </summary>
        public EnergyServicePointJurisdictionCode JurisdictionCode { get; }
