...
{
    /// <summary> The EnergyAccount. </summary>
    public partial class EnergyAccount : EnergyAccountBase
    {
        /// <summary> Initializes a new instance of EnergyAccount. </summary>
        ...
        internal EnergyAccount(string accountId, string creationDate, List<EnergyAccountAllOfPlans> plans) : base(accountId, creationDate)
        {
            if (accountId == null)
            {
        ...
        /// <param name="creationDate"> The date that the account was created or opened. </param>
        /// <param name="plans"> The array of plans containing service points and associated plan details. </param>
        internal EnergyAccount(string accountId, string accountNumber, string displayName, string creationDate, IReadOnlyList<EnergyAccountAllOfPlans> plans) : base(accountId, accountNumber, displayName, creationDate)
        {
            Plans = plans;
        }

        /// <summary> The array of plans containing service points and associated plan details. </summary>
        public IReadOnlyList<EnergyAccountAllOfPlans> Plans { get; }
    }
}
