...
namespace Agl.Cdr.Energy
{
    ...
    public readonly partial struct Enum1 : IEquatable<Enum1>
    {
        ...
        public static Enum1 Electricity { get; } = new Enum1(ElectricityValue);
        /// <summary> GAS. </summary>
        public static Enum1 GAS { get; } = new Enum1(GASValue);
        /// <summary> DUAL. </summary>
        public static Enum1 Dual { get; } = new Enum1(DualValue);
        /// <summary> ALL. </summary>
        public static Enum1 ALL { get; } = new Enum1(ALLValue);
        /// <summary> Determines if two <see cref="Enum1"/> values are the same. </summary>
