...
namespace Agl.Cdr.Admin.Models
{
    ...
    public partial class AverageResponseMetricsV2LowPriority
    {
        /// <summary> Initializes a new instance of AverageResponseMetricsV2LowPriority. </summary>
        internal AverageResponseMetricsV2LowPriority()
        {
        ...
        internal AverageResponseMetricsV2LowPriority(float? currentDay, IReadOnlyList<float> previousDays)
        {
