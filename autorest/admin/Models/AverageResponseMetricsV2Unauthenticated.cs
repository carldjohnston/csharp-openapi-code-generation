...
namespace Agl.Cdr.Admin.Models
{
    ...
    {
        /// <summary> Initializes a new instance of AverageResponseMetricsV2Unauthenticated. </summary>
        internal AverageResponseMetricsV2Unauthenticated()
        {
        ...
        internal AverageResponseMetricsV2Unauthenticated(float? currentDay, IReadOnlyList<float> previousDays)
        {
