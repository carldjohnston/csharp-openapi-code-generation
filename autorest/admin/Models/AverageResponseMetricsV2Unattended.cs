...
namespace Agl.Cdr.Common.Models
{
    ...
    public partial class AverageResponseMetricsV2Unattended
    {
        /// <summary> Initializes a new instance of AverageResponseMetricsV2Unattended. </summary>
        internal AverageResponseMetricsV2Unattended()
        {
        ...
        internal AverageResponseMetricsV2Unattended(float? currentDay, IReadOnlyList<float> previousDays)
        {
