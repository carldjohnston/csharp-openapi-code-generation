...
namespace Agl.Cdr.Admin.Models
{
    ...
    public partial class InvocationMetricsV2Unauthenticated
    {
        /// <summary> Initializes a new instance of InvocationMetricsV2Unauthenticated. </summary>
        internal InvocationMetricsV2Unauthenticated()
        {
        ...
        internal InvocationMetricsV2Unauthenticated(float? currentDay, IReadOnlyList<float> previousDays)
        {
