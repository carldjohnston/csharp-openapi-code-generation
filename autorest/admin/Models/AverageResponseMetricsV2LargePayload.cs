...
namespace Agl.Cdr.Admin.Models
{
    ...
    public partial class AverageResponseMetricsV2LargePayload
    {
        /// <summary> Initializes a new instance of AverageResponseMetricsV2LargePayload. </summary>
        internal AverageResponseMetricsV2LargePayload()
        {
        ...
        internal AverageResponseMetricsV2LargePayload(float? currentDay, IReadOnlyList<float> previousDays)
        {
