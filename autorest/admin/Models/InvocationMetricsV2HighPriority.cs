...
namespace Agl.Cdr.Admin.Models
{
    ...
    public partial class InvocationMetricsV2HighPriority
    {
        /// <summary> Initializes a new instance of InvocationMetricsV2HighPriority. </summary>
        internal InvocationMetricsV2HighPriority()
        {
        ...
        internal InvocationMetricsV2HighPriority(float? currentDay, IReadOnlyList<float> previousDays)
        {
